...
export class SiGateway implements OnGatewayConnection, OnGatewayDisconnect {
	...
	handleConnection(client: Socket) {
		...
		let userId = client.handshake.auth.userid || client.handshake.headers.userid;
	...
	handleJoinRoom(@MessageBody("data") data: JoinDto, @ConnectedSocket() client: Socket) {
	...
	handleMessage(client: Socket, _payload: any): any {
